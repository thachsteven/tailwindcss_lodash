    ...
    <div>
      ...
      <div className="grid grid-cols-6">
        ...
        <div className="col-span-5">
          <div className="text-center text-purple-400 text-8xl mt-5">Menu</div>
                ...
                {_.filter(data, (item) => item.maDanhMuc === maDanhMuc).map((item, index) => {
                  return (
                    <div key={index} className="p-4 lg:w-1/3">
                      <div className="h-full bg-gray-100 bg-opacity-75 px-8 pb-24 rounded-lg overflow-hidden text-center relative">
                        ...
                        <div className="text-center leading-none flex justify-end absolute bottom-0 left-0 w-full pb-5 ">
                          <span className="text-gray-400 mr-3 inline-flex items-center leading-none  pr-3 text-xl  ">
                            Giá: {item.gia}
                          </span>
                        </div>
                      </div>
